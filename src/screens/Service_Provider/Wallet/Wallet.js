...
const EarnedList = [
  { title: "Earned", price: "AED 500.00", time: "10:34PM" },
  { title: "Earned", price: "AED 1435.50", time: "8:16PM" },
  { title: "Earned", price: "AED 500.00", time: "9:40AM" },
];
...
const Wallet = ({ navigation }) => {
  ...
  return (
    <View style={{ height: AppHeight(100), backgroundColor: COLORS.white }}>
      <CustomHeader title={t("My Wallet")} />
      ...
      <ScrollView>
        <View style={{ paddingHorizontal: 15 }}>
          ...
          >
            <Text style={{ fontWeight: "bold" }}>{t("Earning Stats")}</Text>
            <TouchableOpacity>
